...
exports.version = "3.29.3"; //# sourceMappingURL=version.js.map
}}),
 ...
 */ const getAsyncLocalStorage = async ()=>{
    // eslint-disable-next-line @typescript-eslint/no-misused-promises, no-async-promise-executor
    als !== null && als !== void 0 ? als : als = new Promise(async (resolve)=>{
        try {
            const { AsyncLocalStorage } = await Promise.resolve().then(()=>__importStar(__turbopack_require__("[externals]/node:async_hooks [external] (node:async_hooks, cjs)")));
...
const InngestExecution_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/execution/InngestExecution.js [app-route] (ecmascript)");
const als_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/execution/als.js [app-route] (ecmascript)");
...
class V1InngestExecution extends InngestExecution_js_1.InngestExecution {
     ...
     */ async startExecution() {
        return (0, als_js_1.getAsyncLocalStorage)().then((als)=>als.run({
                ctx: this.fnArg
            }, async ()=>{
                var _a, _b, _c, _d, _e, _f, _g;
                /**
...
//# sourceMappingURL=node_modules_inngest_1ff8ae._.js.map